...
public final class FragmentBoardBinding implements ViewBinding {
  ...
  private FragmentBoardBinding(@NonNull LinearLayout rootView, @NonNull ImageView iv1,
      @NonNull ImageView iv2, @NonNull ImageView iv3, @NonNull ViewPager2 viewPager2) {
  ...
  public static FragmentBoardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentBoardBinding((LinearLayout) rootView, iv1, iv2, iv3, viewPager2);
    }
